...
export const HISTORY_HIGH_RES_PHOTO_CACHE_KEY = "ticket-frame.history-high-res-photo-cache.v1";
export const HISTORY_HIGH_RES_PHOTO_CACHE_LIMIT_KEY = "ticket-frame.history-high-res-photo-cache-limit.v1";
